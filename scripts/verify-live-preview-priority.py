...
def main() -> None:
    ...
    print("LIVE_PREVIEW_PRIORITY_OK selection_driven=true missing_before_refresh=true max_generations_per_tick=1 max_attempts_per_tick=1 selected_coverage_ticks=15")
