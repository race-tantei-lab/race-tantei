...
POLICY = ROOT / "scripts" / "official-odds-roi200-policy.py"
...
def main():
    ...
    report = {
        ...
        "productionImplementation": {
            "candidatePolicyPath": "scripts/official-odds-roi200-policy.py",
            "candidatePolicySha256": policy_sha,
            "productionRunnerPath": "scripts/publish-official-odds-roi200-production.py",
        },
        "courses": courses,
