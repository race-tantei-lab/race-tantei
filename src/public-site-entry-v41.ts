...
const UI_VERSION = "ten-year-completed-public-v41-race-day-recovery-20260905";
...
export default {
  ...
  async scheduled(controller: ScheduledController, env: Env, ctx: ExecutionContext): Promise<void> {
    // v37 added public maintenance but stopped delegating to the existing v34
    // race-day scheduler chain. Restore that chain without changing the v37 UI.
    // Run the two recovery paths independently so failure in one cannot suppress
    // the other.
