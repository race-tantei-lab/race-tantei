...
const expected = new Set([
  ...
  "2026-08-16-chukyo-04"
]);

assert(PERFORMANCE_EXCLUSIONS.length === 3, `EXPECTED_THREE_EXCLUSIONS:${PERFORMANCE_EXCLUSIONS.length}`);
...
assert(performanceExclusionForRaceId("2026-08-16-chukyo-04") !== null, "CHUKYO_04_NOT_EXCLUDED");
...
assert(sql.includes("2026-08-16-chukyo-04"), "SQL_MISSING_CHUKYO_04");
